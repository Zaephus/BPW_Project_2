...
public class DungeonGenOnly : MonoBehaviour {
    ...
    public List<RoomTwo> roomList = new List<RoomTwo>();
    ...
    public void Generate() {
        ...
        for(int i = 0; i < numRooms; i++) {
            ...
            RoomTwo room = new RoomTwo(minX,maxX,minY,maxY);
    ...
    public void ConnectRooms(RoomTwo roomOne,RoomTwo roomTwo) {
    ...
    public bool CanConnectRooms(RoomTwo roomOne,RoomTwo roomTwo) {
    ...
    public void AddRoomToDungeon(RoomTwo room) {
        for(int x = room.minX; x <= room.maxX; x++) {
            for(int y = room.minY; y <= room.maxY; y++) {
    ...
    public bool CanRoomFitInDungeon(RoomTwo room) {
...
public class RoomTwo {
    ...
    public List<RoomTwo> connectedRooms = new List<RoomTwo>();

    public RoomTwo(int _minX,int _maxX,int _minY,int _maxY) {
        minX = _minX;
        maxX = _maxX;
        minY = _minY;
        maxY = _maxY;
